...
class TestDB(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user_1 = User(username='Ann', id="1cf96ab3-f693-4909-9d32-067438bc9636", partner_id=2, email='ann@test.com')
        self.user_2 = User(username='Bob', id="49dcc18d-0e6b-43a7-82c3-c8396fc77ee5", partner_id=1, email='bob@test.com')
        db.session.add(self.user_1)
        db.session.add(self.user_2)
        db.session.commit()
        # Create 2 task records and add them to db
        self.task_1 = Task(creator_id="1cf96ab3-f693-4909-9d32-067438bc9636", receiver_id="49dcc18d-0e6b-43a7-82c3-c8396fc77ee5", title='title_1', description='description_1', cost=10, deadline=datetime.fromtimestamp(1596477600))
        self.task_2 = Task(creator_id="49dcc18d-0e6b-43a7-82c3-c8396fc77ee5", receiver_id="1cf96ab3-f693-4909-9d32-067438bc9636", title='title_2', description='description_2', cost=25, deadline=datetime.fromtimestamp(1608442620))
